...
4. **Register the webhook**: after deployment, open your worker's URL once in a browser (Cloudflare dashboard → Workers & Pages → your worker). The page shows a status list and registers the webhook automatically.
